 ...
 * @tree: pointer to the root  the tree to measure the height of
 *
...
/**
 * binary_tree_level - perfor a specific level of a binary tree
 * @tree: pointer to the root of the tree
 * @l: level of the tree to perform
...
/**
 * binary_tree_levelorder - binary tree using level-order 
