 ...
 *
 * Return: 1 if node is a leaf, and failure otherwise, return failure
 */
 ...
 *
 * Return: the height of the tree. return failure
 */
 ...
 *
 * Return: 1 if perfect, failure otherwise., return failure
 */
 ...
 * @tree: pointer to the root node of the tree to check
 *
 * Return: 1 if complete, failure otherwise. 
 */
