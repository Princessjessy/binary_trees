 ...
 *
 * Return: Height or failure tree is NULL
 */
...
/**
 * tree_size_h - the sum of heights of a binary tree
 * @tree: pointer to the  tree to measure the height
 *
 * Return: Height or failure
 */
...
/**
 * _preorder - a binary tree using pre-order traversal
 *
...
/**
 * heap_extract - extracts the a Max Binary Heap
 *
